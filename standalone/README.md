...
docker buildx build --platform linux/amd64,linux/arm64 -t ghcr.io/raymonbb/domely-adapter:0.1.2 agent/adapter
docker buildx build --platform linux/amd64,linux/arm64 -t ghcr.io/raymonbb/domely-api:0.1.2 agent/api
docker buildx build --platform linux/amd64,linux/arm64 -t ghcr.io/raymonbb/domely-tunnel:0.1.2 agent/tunnel
```

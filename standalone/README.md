...
docker buildx build --platform linux/amd64,linux/arm64 --build-arg BUILD_VERSION=0.1.7 -t ghcr.io/raymonbb/domely-adapter:0.1.7 agent/adapter
docker buildx build --platform linux/amd64,linux/arm64 --build-arg BUILD_VERSION=0.1.7 -t ghcr.io/raymonbb/domely-api:0.1.7 agent/api
docker buildx build --platform linux/amd64,linux/arm64 --build-arg BUILD_VERSION=0.1.7 -t ghcr.io/raymonbb/domely-tunnel:0.1.7 agent/tunnel
```
